...
// don't display the button if there are not enough posts
    ...
    <div id="bootdi_loadmore" class=" btn btn-primary">Load more</div>
</div>';
        echo "\n<script>\n";
        echo "var ajaxurl = '" . site_url() . "/wp-admin/admin-ajax.php';\n";
        echo "var bootdi_posts = '" . serialize($wp_query->query_vars) . "';\n";
...
function bootdi_load_more_scripts()
{
...
add_action('wp_enqueue_scripts', 'bootdi_load_more_scripts');

function bootdi_load_posts()
{
...
add_action('wp_ajax_loadmore', 'bootdi_load_posts');
add_action('wp_ajax_nopriv_loadmore', 'bootdi_load_posts');
